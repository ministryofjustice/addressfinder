...
from address.models import DeliveryPointAddress
from address.utils import DeliveryPointAddressFormatter


class DeliveryPointAddressFormatterTestCase(TestCase):

    def test_simple_address(self):
        a = DeliveryPointAddress(
            building_number=16,
        ...
        self.assertEqual(
            DeliveryPointAddressFormatter.format(a),
            u'16 Vixen Road\nBraddock\nKT6 5BT'
        )
